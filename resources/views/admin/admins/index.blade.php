                            ...
                            <div class="col-sm-12">
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" >Role ID</th>
                                    ...
                                    @foreach($admins as $admin)
                                        <tr>
                                            ...
                                            <td>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLabel">Deleting admin</h5>
                                                ...
                                                <!-- Modal -->
                                                <button class="btn btn-danger" data-id="{{$admin->id}}" data-toggle="modal" data-target="#exampleModal">Delete</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
